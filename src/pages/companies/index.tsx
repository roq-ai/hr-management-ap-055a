...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'customer.count', 'employee.count', 'hr_manager.count', 'owner.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'postal_code', header: 'Postal Code', accessorKey: 'postal_code' },
    ...
    hasAccess('customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.customer,
        }
      : null,
