...
import { useRoqPlatformUserProfiles, useHrManagerCount, useEmployeeCount } from 'lib/roq';

import { HrManagerListPage as ShowCaseList } from 'pages/hr-managers';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`hr-managers`} passHref legacyBehavior>
                  <Button
