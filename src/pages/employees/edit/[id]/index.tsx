    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="date_of_joining" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Date Of Joining
            </FormLabel>
            <DatePicker
              selected={formik.values?.date_of_joining ? new Date(formik.values?.date_of_joining) : null}
              onChange={(value: Date) => formik.setFieldValue('date_of_joining', value)}
            />
          </FormControl>
          <FormControl id="date_of_leaving" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Date Of Leaving
            </FormLabel>
            <DatePicker
              selected={formik.values?.date_of_leaving ? new Date(formik.values?.date_of_leaving) : null}
              onChange={(value: Date) => formik.setFieldValue('date_of_leaving', value)}
            />
          </FormControl>
